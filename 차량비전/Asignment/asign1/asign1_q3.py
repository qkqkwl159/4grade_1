...
catGray = cv2.cvtColor(catColor,cv2.COLOR_BGR2GRAY)
puppyGray = cv2.cvtColor(puppyColor,cv2.COLOR_BGR2GRAY)

saturationImg = catGray + puppyGray
WrappingImg = cv2.add(catGray,puppyGray)
